...
def calculate_demographic_data(print_data=True):
  ...
  percentage_bachelors = df[df['education'] == 'Bachelors']['education'].count(
  ...
  higher_education_rich = higher_education[
    ...
    '>50K']['education'].count() / higher_education['education'].count() * 100
  lower_education_rich = lower_education[lower_education['salary'] == '>50K'][
    'education'].count() / lower_education['education'].count() * 100
  ...
  highest_earning_country = df[
    df['salary'] == '>50K']['native-country'].value_counts().idxmax()
  highest_earning_country_percentage = df[
    df['salary'] == '>50K']['native-country'].value_counts().max(
